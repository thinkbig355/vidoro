...
const supabaseKey =
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im13cHlvcmF5cWZ5cmNwY2x5aG1rIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzY1MTg0OTUsImV4cCI6MjA1MjA5NDQ5NX0.3tl92mwRQotJ_p95O7a2R4PKO2ecYF7_tBuUxLvJX6M";
                ...
                >
                    ...
                    >
                        ...
                        <div>
                            ...
                            {errors.channelLink && (
                                <p className="text-red-500 text-sm mt-1">
                                    {errors.channelLink.message as string}
                                </p>
                            )}
                        </div>
